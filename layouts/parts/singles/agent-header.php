...
<header class="main-content-header">
    ...
    <div class="container-card">
        ...
        <?php endif; ?>
        <div class="widget">
            <h3 class="label <?php echo ($entity->isPropertyRequired($entity,"shortDescription") && $this->isEditable()? 'required': '');?>">
                <?php \MapasCulturais\i::_e("Descrição curta");?> <?php if($this->isEditable()) {?>
                    (<span data-element='countLength'><?=mb_strlen($entity->shortDescription)?></span><?php \MapasCulturais\i::_e("/900 Caracteres");?>)
                <?php }?>
            </h3>
            <span
                class="js-editable"
                ...
                data-tpl='<textarea data-element="shortDescription" maxlength="900"></textarea>'
            >
                <?php echo $this->isEditable() ? $entity->shortDescription : nl2br($entity->shortDescription); ?>
            </span>
        </div>
