...
<div class="widget">
    ...
    <?php if($this->isEditable()): ?>
        <span id="term-area" class="js-editable-taxonomy" data-original-title="<?php echo "Municípios Contemplados" ?>" data-emptytext="<?php echo "Informe, pelo menos, um município." ?>" data-restrict="true" data-taxonomy="municipio"><?php echo implode('; ', $selected)?></span>
    <?php else: ?>
