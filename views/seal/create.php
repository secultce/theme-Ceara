        ...
        <div id="sobre" class="aba-content">
            <div class="ficha-spcultura">
                <p>
                    <span
                        class="label
                        <?= ($entity->isPropertyRequired($entity,"shortDescription") && $this->isEditable() ? 'required': '') ?>"
                    >
                        <?php \MapasCulturais\i::_e("Descrição curta:");?>
                        <span data-element='countLength'> <?php if($this->isEditable()) echo mb_strlen($entity->shortDescription); ?>
                        </span>
                        <?php \MapasCulturais\i::_e("/900 Caracteres");?>
                    </span>
                    <br>
