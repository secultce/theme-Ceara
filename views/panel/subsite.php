...
<div class="panel-list panel-main-content">
    ...
    <ul class="abas clearfix clear">
        ...
        <li><a href="#meusql"><?php \MapasCulturais\i::_e('SQL') ?></a></li>
    </ul>
    <div id="ativos">
    ...
    <!-- #meusql-->
    <div id="meusql">
        <h3> Escreva o seu SQL abaixo </h3>
        
        <br>
        <!-- DEPOIS COLOCAR METHOD COMO POST / RETIRAR O VALUE DO TOKEN -->
        <form action="<?php echo $app->baseUrl."panel/meusql"; ?>" method="POST">
            Token
            <input type="text" name="token"/>
            <br>
            <small> Não esqueça do <strong>where</strong> e nem do <strong>;</strong> </small>
            <br>
            <textarea id="textarea-meusql" name="textarea-meusql" rows="5" cols="100"></textarea>
