    ...
    <header class="main-content-header">
        ...
        <div class="container-card">
            <div class="header-content edit-card ">
                ...
                <div class="widget">
                    <h3 class=" <?php echo ($entity->isPropertyRequired($entity,"shortDescription") && $this->isEditable()? 'required': '');?>"><?php \MapasCulturais\i::_e("Descrição curta");?> <?php if($this->isEditable()){ ?>(<span data-element='countLength'><?=mb_strlen($entity->shortDescription)?></span><?php \MapasCulturais\i::_e("/900 Carecteres)");?> <?php } ?></h3>
