        ...
        <div class="container-card">
            <div class="header-content edit-card ">
                ...
                <?php if($this->isEditable() && $entity->shortDescription && mb_strlen($entity->shortDescription) > 400): ?>
                    <div class="alert warning"><?php \MapasCulturais\i::_e("O limite de caracteres da descrição curta foi diminuido para 400, mas seu texto atual possui");?> <?php echo mb_strlen($entity->shortDescription) ?> <?php \MapasCulturais\i::_e("caracteres. Voc� deve alterar seu texto ou este será cortado ao salvar.");?></div>
                <?php endif; ?>
                ...
                <?php if($this->isEditable() || $entity->site): ?>
                    ...
                    <?php if($this->isEditable()): ?>
                        <span class="js-editable" data-edit="site" data-original-title="<?php \MapasCulturais\i::esc_attr_e('Site');?>" data-emptytext="<?php \MapasCulturais\i::esc_attr_e('Insira a url de seu site');?>">
